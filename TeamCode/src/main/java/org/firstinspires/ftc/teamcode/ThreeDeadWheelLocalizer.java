...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1947.2851233562917; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1993.1172511791033; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2458.4950363905086; // x position of the perpendicular encoder (in tick units)
    }
